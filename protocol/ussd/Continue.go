...
var _ protocol.PacketWriter = (*Continue)(nil)
var _ protocol.PacketReader = (*Continue)(nil)
...
func (me*Continue) Read(r *protocol.DataReader) {
...
func (me*Continue) Write(w *protocol.DataWriter) {
